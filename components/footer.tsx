export default function Footer() {
  return (
    <footer className="row-start-3 flex gap-6 flex-wrap items-center justify-center py-4 sm:py-6 px-8 mt-6 md:mt-12 border-t border-stone-200 dark:border-stone-800">
